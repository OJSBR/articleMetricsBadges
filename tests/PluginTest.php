...
/**
 * @file plugins/generic/articleMetricsBadges/tests/PluginTest.php
 *
...
class PluginTest extends PKPTestCase
{
    ...
    {
        return [
            \APP\plugins\generic\articleMetricsBadges\ArticleMetricsBadgesBlockPlugin::class,
            \APP\plugins\generic\articleMetricsBadges\ArticleMetricsBadgesPlugin::class,
            \APP\plugins\generic\articleMetricsBadges\ArticleMetricsBadgesSettingsForm::class,
        ];
    }
